...
<table class="table table-bordered">
  ...
  HttpSession httpSession = request.getSession();
	...
	try{
		...
		ResultSet rs = stmt.executeQuery("select *from user where user_name like '%"+search+"%' or user_email like '%"+search+"%' or user_phone like '%"+search+"%' ");
		while(rs.next()){
		z=1;
...
<a href="admin.jsp" class="text-center d-block mb-2"><b>Redirect to Admin-Home View Page</b></a>
